...
Commands:
  ...
  fetch-overview    Fetch latest FY overview for tickers (SEC EDGAR, optional StockAnalysis fallback)
...
Notes:
  ...
  - SEC output is latest FY summary; 5-year history/graphs are not implemented yet.
