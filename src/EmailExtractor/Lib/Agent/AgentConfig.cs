...
)
{
    public static AgentConfig FromEnv()
    {
        ...
        return new AgentConfig(
            ...
            OpenAiMaxTokens: ClampInt(Env.GetInt("OPENAI_MAX_TOKENS", 2048), 64, 16384),
            OpenAiTemperature: ClampDouble(Env.GetDouble("OPENAI_TEMPERATURE", 0.7), 0.0, 2.0),
            ...
            AgentMaxConversationTurns: ClampInt(Env.GetInt("AGENT_MAX_CONVERSATION_TURNS", 10), 1, 200),
            OutDir: outDir,
